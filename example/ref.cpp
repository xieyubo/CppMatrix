...
int main()
{
    ...
    spdlog::info("Matrix size: {}, number of elements {}", bufferSize, N);
    {
    ...
    WGPUComputePipeline computePipeline;
    {
        ...
        computePipelineDesc.compute.module = wgpuDeviceCreateShaderModule(device, &shaderModuleDesc);
    ...
    spdlog::info("Create the command encoder");
    {
        ...
        computePassEncoder = wgpuCommandEncoderBeginComputePass(commandEncoder, nullptr);
    ...
    };
    {
        ...
        CallbackData callbackData = CallbackData { readbackBuffer, sizeof(outputArr), nullptr, &promise };
    ...
    printf("%s\n", show<float, N>(inputArr, "GELU Input").c_str());
    printf("%s\n", show<float, N>(outputArr, "GELU Output").c_str());
    printf("Done with GELU kernel\n");
}